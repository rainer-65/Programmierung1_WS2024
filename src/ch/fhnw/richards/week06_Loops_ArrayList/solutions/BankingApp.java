...
public class BankingApp extends Application {
	...
	// Our decimal formatter (define once, use many times)
	private DecimalFormat formatter = new DecimalFormat("0.00");  // <-- New!!!
	...
	private void withdraw(ActionEvent e) {
		...
		lblAccountBalance.setText("Kontostand: CHF " + formatter.format(accountBalance)); // <-- Uses formatter !!
	}
